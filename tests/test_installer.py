...
def test_compile_installer_uses_path_makensis_command(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    """makensis 命令首参数为 "makensis"（PATH 查找，无缓存管理）."""
    out = tmp_path / "out.exe"
    seen: list[list[str]] = []
